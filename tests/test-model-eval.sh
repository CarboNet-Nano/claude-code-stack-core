#!/usr/bin/env bash
# Tests for the /model-eval harness (plan: .claude/plans/2026-08-07-model-matrix-eval.md).
...
PLAN="$REPO_ROOT/.claude/plans/2026-08-07-model-matrix-eval.md"
...
CONSUMERS_OK=1
for consumer in "$REPO_ROOT/skills/goodmorning/SKILL.md" "$REPO_ROOT/skills/handoff/SKILL.md"; do
  [[ -f "$consumer" ]] || continue
